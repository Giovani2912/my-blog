...
const Blog = () => {
    ...
    const getBlogs = () => {
        ...
        // RENDERIZANDO/MAPEANDO AS LINHAS COM 2 BLOGS CADA LINHA
        blogs.map(blogPost => {
            return list.push(
        ...
        <div className="container mt-3">
            <div className="nav-scroller py-1 mb-2">
                <nav className="nav d-flex justify-content-between">
                    ...
                    <Link className="p-2 text-muted" to='/category/e_sport'>E-Sport</Link>
            ...
            <div className="jumbotron p-2 p-md-5 mb-5 text-white rounded bg-dark">
...
//{getBlogs()}, ACIMA DO ENCERRAMENTO DA DIV ==>  
//CHAMANDO A FUNÇÃO GETBLOGS(), QUE FOI ESCRITA ANTES DO RETURN, COM A FUNÇÃO DE REENDERIZAR OS BLOGS POSTADOS
